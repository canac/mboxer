...
// source-hash: c14b67f9f8d87b3393ce874c2a83da14270c8752
let wasm;
...
export class MessageResult {
  static __wrap(ptr) {
    ...
    obj.ptr = ptr;
    MessageResultFinalization.register(obj, obj.ptr, obj);
    return obj;
  }
  ...
  get id() {
    try {
      ...
      wasm.messageresult_id(retptr, this.ptr);
  ...
  get sender() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.messageresult_sender(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
  ...
  get subject() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.messageresult_subject(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
  ...
  get date() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.messageresult_date(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
  ...
  get content() {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.messageresult_content(retptr, this.ptr);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      let v0;
      if (r0 !== 0) {
 ...
 *   exports: { parse_message: typeof parse_message; MessageResult : typeof MessageResult  }
 * }>}
 */
...
function getWasmInstanceExports() {
  return { parse_message, MessageResult };
}
...
async function instantiateModule(opts) {
  const wasmUrl = opts.url ?? new URL("parser_lib_bg.wasm", import.meta.url);
